...
public class Commit implements Serializable {
  //Fields
    ...
    String commitID;
    String message;
    HashMap<String,String> nameToBlobID=new HashMap<>();
    //first string is file name, second is hashcode hashed from contents of bolb
    ...
    */
    ...
    public static void serialization(Commit commit, String fileName){
        try{
            ObjectOutput out=new ObjectOutputStream(new FileOutputStream(".gitlet/commits/" +fileName+".ser"));
    ...
    public static Commit deserialization(String fileName){
        Commit commit=null;
        try {
            ObjectInputStream inp = new ObjectInputStream(new FileInputStream(".gitlet/commits/" + fileName + ".ser"));
