...
public class BinarySearchTreeMethodsTest {
    ...
    public void isInTreeTest2() {
         ...
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "");
        /*
         * Assert that values of variables match expectations
         */
        assertEquals(true, inTree);
    ...
    @Test
    public void isInTreeTest3() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("c", "a", "b", "d", "e");
        BinaryTree<String> t2 = createBSTFromArgs("c", "a", "b", "d", "e");
        /*
         * Call method under test
         */
    ...
    public void removeSmallestTest1() {
         ...
         */
        BinaryTree<String> t1 = createBSTFromArgs("c", "a", "b", "d", "e");
        BinaryTree<String> t2 = createBSTFromArgs("c", "b", "d", "e");
        /*
         * Call method under test
         */
