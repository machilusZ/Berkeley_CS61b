...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_1 = "test/statement1.bl",
            ...
            FILE_NAME_3 = "test/statement3ifelse.bl",
     ...
     */
    @Test
    public final void testParseSmallValid() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
    ...
    /**
     * Tests for noticing an incorrect keyword.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorIncorrectKeyword() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
